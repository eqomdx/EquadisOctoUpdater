...
> ### This is a fork
>
> Octo Updater is created and maintained by
> **[rebasedkon](https://github.com/rebasedkon/octo-updater)**.
> This repository adds a one-click installer and a small set of patches;
> everything else is the original author's work. Please support them:
> [Ko-fi](https://ko-fi.com/rebased) &middot;
...
>
> Click the green **Code** button above, choose **Download ZIP**, extract it,
> and double-click **`install/INSTALL.cmd`**.
>
> Or paste this into PowerShell and skip the download entirely:
>
> ```powershell
> irm https://raw.githubusercontent.com/eqomdx/EquadisOctoUpdater/main/install/install.ps1 | iex
> ```
>
> Either way it installs Python if you need it, patches and compiles Octo
> Updater, then finds, backs up and configures your OctoWoW folder. No
> administrator rights, and it is safe to run more than once.
> Details in [`install/README.md`](install/README.md).
